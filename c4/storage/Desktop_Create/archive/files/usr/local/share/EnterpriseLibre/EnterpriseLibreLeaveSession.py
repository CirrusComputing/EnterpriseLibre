...
class EnterpriseLibreLeaveSessionGTK:
	def __init__(self):
		try:
			self.builder = gtk.Builder()
			self.builder.add_from_file("/usr/local/share/EnterpriseLibre/glade/EnterpriseLibreLeaveSession.glade")
		except:
			self.show_error_dlg("Failed to load UI XML file: EnterpriseLibreLeaveSession.glade")
			sys.exit(1)
...
if __name__ == "__main__":
	EnterpriseLibreLeaveSessionGTK()
	gtk.main()
