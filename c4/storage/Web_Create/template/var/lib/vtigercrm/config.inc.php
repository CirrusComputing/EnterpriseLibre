...
$PORTAL_URL = 'http://vtiger.[-DOMAIN-]/portal';
...
$dbconfig['db_server'] = 'mysql.[-DOMAIN-]';
$dbconfig['db_port'] = ':3306';
$dbconfig['db_username'] = 'vtiger';
$dbconfig['db_password'] = '[-DB_PASSWORD_VTIGER-]';
...
$site_URL = 'http://vtiger.[-DOMAIN-]';

// root directory path
$root_directory = '/var/lib/vtigercrm/';
...
$application_unique_key = '[-VTIGER_UNIQUE_KEY-]';
...
$MINIMUM_CRON_FREQUENCY = 4;

// LDAP settings
$ldap_host = "ldaps://aphrodite.[-DOMAIN-]:636";
$ldap_base = "ou=people,[-LDAP_BASE_DN-]";
$ldap_bind_dn = "cn=vtiger,ou=applications,ou=system,[-LDAP_BASE_DN-]";
$ldap_bind_pw = "[-LDAP_PASSWORD_VTIGER-]";
